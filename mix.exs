...
defmodule PolyDB.LSP.MixProject do
  use Mix.Project

  @version "0.1.0"
  @source_url "https://github.com/hyperpolymath/poly-db-lsp"
  ...
  def project do
    [
      ...
      # Package info
      name: "PolyDB LSP",
      description: "Language Server Protocol implementation for 21 database systems",
      package: package(),
  ...
  defp deps do
    [
      ...
      # SQL parsing (for query analysis)
      {:nimble_parsec, "~> 1.4"},
